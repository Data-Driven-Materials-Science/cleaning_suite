def return_outliers(data_df, method="Z-Score"):
    """
    ...
    :return: A DataFrame without outliers and a DataFrame with outliers
    ...
    # TODO Implement function for each method above
